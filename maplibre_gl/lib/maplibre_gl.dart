...
/// This library contains the MapVina GL plugin for Flutter.
///
/// To display a map, add a [MapVinaMap] widget to the widget tree.
///
/// In this plugin, the map is configured through the parameters passed to the [MapVinaMap] constructor and through the [MapVinaMapController].
/// The [MapVinaMapController] is provided at runtime by the [MapVinaMap.onMapCreated] callback.
...
///
/// The visual appearance of the map is configured through a MapVina style passed to the
/// [styleString] parameter of the [MapVinaMap] constructor.
/// The MapVina style is a JSON document following the specification at https://mapvina.com/mapvina-style-spec/.
/// The following is supposed to serve as a short introduction to the MapVina style specification:
...
/// Depending on the map's zoom level and viewport, the MapVina client libraries decide, which tiles are needed to fill the viewport and request them from the source.
///
...
///
/// Raster sources are displayed by adding a "raster" layer to the MapVina GL style.
/// Vector and GeoJson sources are displayed by adding a "line", "fill", "symbol" or "circle" layer to the MapVina GL style and specifying
...
import 'package:mapvina_gl_platform_interface/mapvina_gl_platform_interface.dart';

export 'package:mapvina_gl_platform_interface/mapvina_gl_platform_interface.dart'
    show
        Annotation,
        ArgumentCallbacks,
