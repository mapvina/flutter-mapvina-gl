...
import com.mapvina.android.offline.OfflineRegion;
import com.mapvina.android.offline.OfflineRegionDefinition;
import com.mapvina.android.offline.OfflineRegionError;
import com.mapvina.android.offline.OfflineRegionStatus;
import com.mapvina.android.offline.OfflineTilePyramidRegionDefinition;
...
abstract class OfflineManagerUtils {
   ...
   * served from the local MapVina cache (e.g. a previously downloaded region
    ...
    OfflineRegion.OfflineRegionObserver observer =
        new OfflineRegion.OfflineRegionObserver() {
          ...
          public void mapboxTileCountLimitExceeded(long limit) {
            Log.e(TAG, "MapVina tile count limit exceeded: " + limit);
            region.setDownloadState(OfflineRegion.STATE_INACTIVE);
            activeDownloads.remove(region.getId());
            isComplete.set(true);
            channelHandler.onError(
                "mapboxTileCountLimitExceeded",
                "MapVina tile count limit exceeded: " + limit,
                null);
