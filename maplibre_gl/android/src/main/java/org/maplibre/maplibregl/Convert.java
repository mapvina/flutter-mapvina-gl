...
/** Conversions between JSON-like values and MapVinaMaps data types. */
class Convert {
  ...
  static CameraUpdate toCameraUpdate(Object o, MapVinaMap mapvinaMap, float density) {
...
static LocationEngineRequest toLocationEngineRequest(Object o) {
  ...
  static void interpretMapVinaMapOptions(Object o, MapVinaMapOptionsSink sink, Context context) {
