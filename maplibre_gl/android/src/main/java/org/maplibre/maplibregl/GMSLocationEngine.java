...
public class GMSLocationEngine implements LocationEngineImpl<LocationCallback> {
    ...
    /**
     * Converts a MapVina {@link LocationEngineRequest} to a Google Play Services {@link LocationRequest}.
     *
     * @param engineRequest The MapVina location request.
    ...
    /**
     * Maps MapVina LocationEngineRequest priorities to Google Play Services LocationRequest priorities.
     *
    ...
    private int mapPriority(int enginePriority) {
        switch (enginePriority) {
            ...
            default:
                Log.w(TAG, "Unknown MapVina priority: " + enginePriority + ". Defaulting to BALANCED_POWER_ACCURACY.");
     ...
     * to the MapVina LocationEngineCallback.
     */
    @VisibleForTesting
