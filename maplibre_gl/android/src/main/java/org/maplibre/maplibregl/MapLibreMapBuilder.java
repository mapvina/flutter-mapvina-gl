...
class MapVinaMapBuilder implements MapVinaMapOptionsSink {
  ...
  private final MapVinaMapOptions options =
      new MapVinaMapOptions().attributionEnabled(true).logoEnabled(false).textureMode(false);
  ...
  MapVinaMapController build(
      int id,
      Context context,
      BinaryMessenger messenger,
      MapVinaMapsPlugin.LifecycleProvider lifecycleProvider) {

    final MapVinaMapController controller =
        new MapVinaMapController(
            id, 
            context, 
            messenger, 
            lifecycleProvider, 
