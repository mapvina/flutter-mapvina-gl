...
This project is a fork of [flutter-mapbox-gl](https://github.com/tobrun/flutter-mapbox-gl), replacing its usage of Mapbox GL libraries with the open source [MapVina GL](https://github.com/mapvina) libraries.
...
Underlying engines:
* **Android / iOS** — [mapvina-native](https://github.com/mapvina/mapvina-native)
* **Web** — [mapvina-gl-js](https://github.com/mapvina/mapvina-gl-js)
...
```html
<script src='https://unpkg.com/mapvina-gl@^5.24.0/dist/mapvina-gl.js'></script>
<link href='https://unpkg.com/mapvina-gl@^5.24.0/dist/mapvina-gl.css' rel='stylesheet'/>
```
...
Copy mbtiles (or sprites/glyphs) from bundled assets to a writable directory (e.g. cache) and point your style sources there. See issues [#338](https://github.com/mapvina/flutter-mapvina-gl/issues/338) & [#318](https://github.com/mapvina/flutter-mapvina-gl/issues/318) for community approaches.
...
Copy them to a writable directory (cache/documents) first, then reference the new path in the style or source configuration. See issues [#338](https://github.com/mapvina/flutter-mapvina-gl/issues/338) & [#318](https://github.com/mapvina/flutter-mapvina-gl/issues/318).
...
* MapVina upstream projects: [mapvina-gl-js](https://github.com/mapvina/mapvina-gl-js), [mapvina-native](https://github.com/mapvina/mapvina-native)
...
* Discussions: https://github.com/mapvina/flutter-mapvina-gl/discussions
* Bugs / Features: [Open an issue](https://github.com/mapvina/flutter-mapvina-gl/issues/new) (include reproduction details/logs where possible)
