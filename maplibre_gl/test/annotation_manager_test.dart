...
/// Creates a [MapVinaMapController] backed by the given [FakeMapVinaPlatform]
...
Future<MapVinaMapController> _createController(
  FakeMapVinaPlatform platform,
) async {
  final controller = MapVinaMapController(
    mapvinaPlatform: platform,
...
void main() {
  ...
  late FakeMapVinaPlatform platform;
  late MapVinaMapController controller;

  setUp(() async {
    platform = FakeMapVinaPlatform();
  ...
  group('AnnotationManager initialization', () {
    ...
    test('adding annotation before init throws', () {
      final freshPlatform = FakeMapVinaPlatform();
      final freshController = MapVinaMapController(
        mapvinaPlatform: freshPlatform,
        initialCameraPosition: const CameraPosition(target: LatLng(0, 0)),
        annotationOrder: AnnotationType.values,
        annotationConsumeTapEvents: AnnotationType.values,
      );
