...
void main() {
  ...
  setUp(() {
    ...
    final previousFactory = MapVinaPlatform.createInstance;
    addTearDown(() {
      MapVinaPlatform.createInstance = previousFactory;
    });
    MapVinaPlatform.createInstance = () => platform;
  });
  ...
  group('initialCameraPosition', () {
    testWidgets('is included in creationParams when set', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: MapVinaMap(initialCameraPosition: camera),
        ),
      );
