...
/// A call record for verifying interactions with [FakeMapVinaPlatform].
class PlatformCall {
  final String method;
...
/// Fake implementation of [MapVinaPlatform] that records all method calls.
class FakeMapVinaPlatform extends MapVinaPlatform {
