...
---
## Overview
The repository is a multi-package workspace (`mapvina_gl` (root dir), `mapvina_gl_web`, `mapvina_gl_platform_interface`). 
...
```yaml
dependencies:
  mapvina_gl_platform_interface: ^0.25.0
```
