...
/// A page that demonstrates switching between multiple map styles in MapVina GL.
///
...
class _MultiStyleSwitchBodyState extends State<_MultiStyleSwitchBody> {
  ...
  static const String _embeddedMinimalStyle =
      '{"version":8,"glyphs":"https://demotiles.mapvina.com/font/{fontstack}/{range}.pbf","sources":{},"layers":[{"id":"background","type":"background","paint":{"background-color":"#90EE90"}}]}';
  ...
  Future<void> _onMapCreated(MapVinaMapController c) async {
