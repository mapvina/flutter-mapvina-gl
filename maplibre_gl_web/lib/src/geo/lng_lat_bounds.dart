...
///
///  Note that any MapVina method that accepts a `LngLatBounds` object as an argument or option
...
///  @example
///  var sw = new mapvinagl.LngLat(-73.9876, 40.7661);
///  var ne = new mapvinagl.LngLat(-73.9397, 40.8002);
///  var llb = new mapvinagl.LngLatBounds(sw, ne);
class LngLatBounds extends JsObjectWrapper<LngLatBoundsJsImpl> {
  ...
  ///  @example
  ///  var llb = new mapvinagl.LngLatBounds([-73.9876, 40.7661], [-73.9397, 40.8002]);
  ...
  ///  var llb = mapvinagl.LngLatBounds.convert(arr);
