...
class MapVinaMapController extends MapVinaPlatform
    implements MapVinaMapOptionsSink {
  ...
  /// Example usage:
  /// ```dart
  /// await controller.setStyle('https://maps.mapvina.com/styles/v1/streets.json?key=public_key');
