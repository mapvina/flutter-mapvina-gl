...
class Convert {
  ...
  /// This is useful when the style is handled separately (like MapVinaMap initialization).
  static void interpretMapVinaMapOptions(
    Map<String, dynamic> options,
    MapVinaMapOptionsSink sink, {
    ...
    switch (type) {
      ...
      case 'newLatLng':
        ...
        return CameraOptions(
          ...
          zoom: mapVinaMap.getZoom(),
          pitch: mapVinaMap.getPitch(),
          bearing: mapVinaMap.getBearing(),
        );
      case 'newLatLngBounds':
        ...
        final right = json[4];
        final bottom = json[5];
        final camera = mapVinaMap.cameraForBounds(
          LngLatBounds(
      ...
      case 'scrollBy':
        final x = json[1];
        final y = json[2];
        final point = mapVinaMap.project(mapVinaMap.getCenter());
        return CameraOptions(
          center: mapVinaMap.unproject(
      ...
      case 'zoomBy':
        ...
        if (json.length == 2) {
          return CameraOptions(
            center: mapVinaMap.getCenter(),
            zoom: mapVinaMap.getZoom() + zoom,
            pitch: mapVinaMap.getPitch(),
            bearing: mapVinaMap.getBearing(),
          );
        }
        final point = json[2];
        return CameraOptions(
          center: mapVinaMap.unproject(geo_point.Point(point[0], point[1])),
          zoom: mapVinaMap.getZoom() + zoom,
          pitch: mapVinaMap.getPitch(),
          bearing: mapVinaMap.getBearing(),
        );
