...
import 'package:mapvina_gl_web/src/interop/geo/lng_lat_bounds_interop.dart';
import 'package:mapvina_gl_web/src/interop/geo/lng_lat_interop.dart';
import 'package:mapvina_gl_web/src/interop/geo/point_interop.dart';
import 'package:mapvina_gl_web/src/interop/js.dart';
import 'package:mapvina_gl_web/src/interop/style/feature_identifier_interop.dart';
import 'package:mapvina_gl_web/src/interop/style/style_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/camera_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/handler/box_zoom_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/handler/dblclick_zoom_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/handler/drag_pan_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/handler/drag_rotate_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/handler/keyboard_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/handler/scroll_zoom_interop.dart';
import 'package:mapvina_gl_web/src/interop/ui/handler/touch_zoom_rotate_interop.dart';
...
@JS('Map')
@staticInterop
class MapVinaMapJsImpl extends CameraJsImpl {
  external factory MapVinaMapJsImpl(MapOptionsJsImpl options);
}

extension MapVinaMapJsImplExtension on MapVinaMapJsImpl {
  ...
  external MapVinaMapJsImpl addControl(
  ...
  external MapVinaMapJsImpl removeControl(IControlJsImpl? control);
  ...
  external MapVinaMapJsImpl resize([JSAny? eventData]);
  ...
  external MapVinaMapJsImpl setMaxBounds(LngLatBoundsJsImpl? bounds);
  ...
  external MapVinaMapJsImpl setMinZoom([num? minZoom]);
  ...
  external MapVinaMapJsImpl setMaxZoom([num? maxZoom]);
  ...
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl setMinPitch([num? minPitch]);
  ...
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl setMaxPitch([num? maxPitch]);
  ...
  ///  @see [Render world copies](https://mapvina.com/mapvina-gl-js/docs/examples/render-world-copies/)
  external MapVinaMapJsImpl setRenderWorldCopies([bool? renderWorldCopies]);
  ...
  //external MapVinaMap on(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  ///  @returns {MapVinaMap} `this`
  // Defined in evented.dart
  //external MapVinaMap off(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  external MapVinaMapJsImpl setStyle(JSAny? style, [JSAny? options]);
  ...
  external MapVinaMapJsImpl addSource(String id, JSAny source);
  ...
  external MapVinaMapJsImpl addLayer(JSAny layer, [String? beforeId]);
  ...
  external MapVinaMapJsImpl moveLayer(String id, String beforeId);
  ...
  external MapVinaMapJsImpl setLayerZoomRange(
    String layerId,
    num minzoom,
    num maxzoom,
  );
  ...
  external MapVinaMapJsImpl setFilter(
    String layerId,
    JSAny filter, [
  ...
  external MapVinaMapJsImpl setLayoutProperty(
    String layerId,
    String name,
    JSAny? value, [
    StyleSetterOptionsJsImpl? options,
  ...
  ///  @param {boolean} [options.validate=true] Whether to check if the filter conforms to the MapVina JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl setLight(
    JSAny light,
    StyleSetterOptionsJsImpl options,
  );
...
/// WebGL context attributes for MapVina GL JS v5+.
///
...
extension CanvasContextAttributesJsImplExtension
  ...
  /// If `true`, map creation will fail if the performance of MapVina GL JS
...
extension MapOptionsJsImplExtension on MapOptionsJsImpl {
  ...
  /// WebGL context attributes to pass to the canvas. In MapVina GL JS v5+,
...
extension IControlJsImplExtension on IControlJsImpl {
  ...
  ///  internally.
  external HtmlElement onAdd(MapVinaMapJsImpl map);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link MapVinaMap#removeControl}
  ///  internally.
  external JSAny? onRemove(MapVinaMapJsImpl map);
