...
extension CameraJsImplExtension on CameraJsImpl {
  ...
  ///  @example
  ///  map.setCenter([-74, 38]);
  external MapVinaMapJsImpl setCenter(LngLatJsImpl center, [JSAny? eventData]);
  ...
  external MapVinaMapJsImpl panBy(
    PointJsImpl offset, [
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl panTo(
    LngLatJsImpl lnglat, [
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  // zoom the map to 5
  ///  map.setZoom(5);
  external MapVinaMapJsImpl setZoom(num zoom, [JSAny? eventData]);
  ...
  ///  @fires zoomend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl zoomTo(
    num zoom, [
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  @fires zoomend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl zoomIn([
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  @fires zoomend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl zoomOut([
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  map.setBearing(90);
  external MapVinaMapJsImpl setBearing(num bearing, [JSAny? eventData]);
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl rotateTo(
    num bearing, [
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl resetNorth([
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl resetNorthPitch([
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl snapToNorth([
    AnimationOptionsJsImpl? options,
    JSAny? eventData,
  ]);
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl setPitch(num pitch, [JSAny? eventData]);
  ...
  external MapVinaMapJsImpl fitBounds(
    LngLatBoundsJsImpl bounds, [
    JSAny? options,
    JSAny? eventData,
  ]);
  ...
  external MapVinaMapJsImpl fitScreenCoordinates(
    PointJsImpl p0,
    PointJsImpl p1,
    num bearing, [
    JSAny? options,
  ...
  ///  @fires pitchend
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl jumpTo(
    CameraOptionsJsImpl options, [
    JSAny? eventData,
  ]);
  ...
  ///  @returns {MapVinaMap} `this`
  ///  @see [Navigate the map with game-like controls](https://mapvina.com/mapvina-gl-js/docs/examples/game-controls/)
  external MapVinaMapJsImpl easeTo(JSAny options, [JSAny? eventData]);
  ...
  external MapVinaMapJsImpl flyTo(JSAny options, [JSAny? eventData]);
  ...
  ///  @memberof MapVinaMap#
  ///  @returns {MapVinaMap} `this`
  external MapVinaMapJsImpl stop();
}
