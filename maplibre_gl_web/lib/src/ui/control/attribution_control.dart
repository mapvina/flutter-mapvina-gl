...
import 'package:mapvina_gl_web/src/interop/ui/control/attribution_control_interop.dart';
...
/// @example
/// var attribution = new mapvinagl.AttributionControl();
/// map.addControl(attribution, 'top-left');
/// @see [Display map attribution controls](https://mapvina.com/mapvina-gl-js/docs/examples/attribution-position/)
