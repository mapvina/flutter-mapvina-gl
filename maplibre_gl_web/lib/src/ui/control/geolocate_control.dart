...
///
/// @example
/// map.addControl(new mapvinagl.GeolocateControl({
///     positionOptions: {
///         enableHighAccuracy: true
///     },
///     trackUserLocation: true
/// }));
/// @see [Locate the user](https://mapvina.com/mapvina-gl-js/docs/examples/locate-user/)
class GeolocateControl extends Evented {
  ...
  onAdd(MapVinaMap map) => jsObject.onAdd(map.jsObject);
...
/// The MapVina GL JS 'geolocate' event contains the browser's
