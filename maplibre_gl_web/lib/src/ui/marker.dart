...
import 'package:mapvina_gl_web/src/ui/popup.dart';
...
/// ```dart
/// var marker = mapvinagl.Marker()
///   .setLngLat([30.5, 50.5])
///   .addTo(map);
/// ```
/// @see [Add custom icons with Markers](https://mapvina.com/mapvina-gl-js/docs/examples/custom-marker-icons/)
/// @see [Create a draggable Marker](https://mapvina.com/mapvina-gl-js/docs/examples/drag-a-marker/)
class Marker extends Evented {
  ...
  ///  @param {MapVinaMap} map
  ///  @returns {Marker} `this`
  Marker addTo(MapVinaMap map) =>
      Marker.fromJsObject(jsObject.addTo(map.jsObject));

  ///  Removes the marker from a map
  ///  @example
  ///  var marker = new mapvinagl.Marker().addTo(map);
  ///  marker.remove();
  ///  @returns {Marker} `this`
