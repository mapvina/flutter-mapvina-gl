...
import 'package:mapvina_gl_web/src/geo/geojson.dart';
import 'package:mapvina_gl_web/src/geo/lng_lat.dart';
import 'package:mapvina_gl_web/src/geo/lng_lat_bounds.dart';
import 'package:mapvina_gl_web/src/interop/interop.dart';
import 'package:mapvina_gl_web/src/geo/point.dart';
import 'package:mapvina_gl_web/src/style/layers/layer.dart';
import 'package:mapvina_gl_web/src/style/sources/geojson_source.dart';
import 'package:mapvina_gl_web/src/style/sources/source.dart';
import 'package:mapvina_gl_web/src/utils.dart' as utils;
import 'package:mapvina_gl_web/src/style/sources/vector_source.dart';
import 'package:mapvina_gl_web/src/style/style.dart';
import 'package:mapvina_gl_web/src/ui/camera.dart';
import 'package:mapvina_gl_web/src/ui/handler/box_zoom.dart';
import 'package:mapvina_gl_web/src/ui/handler/dblclick_zoom.dart';
import 'package:mapvina_gl_web/src/ui/handler/drag_pan.dart';
import 'package:mapvina_gl_web/src/ui/handler/drag_rotate.dart';
import 'package:mapvina_gl_web/src/ui/handler/keyboard.dart';
import 'package:mapvina_gl_web/src/ui/handler/scroll_zoom.dart';
import 'package:mapvina_gl_web/src/ui/handler/touch_zoom_rotate.dart';

///  The `MapVinaMap` object represents the map on your page. It exposes methods
///  and properties that enable you to programmatically change the map,
///  and fires events as users interact with it.
///
///  You create a `MapVinaMap` by specifying a `container` and other options.
///  Then MapVina JS JS initializes the map on the page and returns your `MapVinaMap`
///  object.
///
///  ```dart
///  var map = MapVinaMap(
...
///  );
///  ```
///  @see [Display a map](https://mapvina.com/mapvina-gl-js/docs/examples/simple-map/)
class MapVinaMap extends Camera {
  @override
  final MapVinaMapJsImpl jsObject;

  factory MapVinaMap(MapOptions options) =>
      MapVinaMap.fromJsObject(MapVinaMapJsImpl(options.jsObject));
  ...
  ///  @returns {MapVinaMap} `this`
  ///  @example
  ///  // Add zoom and rotation controls to the map.
  ///  map.addControl(new NavigationControl());
  ///  @see [Display map navigation controls](https://mapvina.com/mapvina-gl-js/docs/examples/navigation/)
  MapVinaMap addControl(dynamic control, [String? position]) {
    if (position != null) {
      return MapVinaMap.fromJsObject(
        jsObject.addControl(control.jsObject, position),
      );
    }
    return MapVinaMap.fromJsObject(jsObject.addControl(control.jsObject));
  }
  ...
  MapVinaMap removeControl(dynamic control) =>
      MapVinaMap.fromJsObject(jsObject.removeControl(control.jsObject));
  ...
  MapVinaMap resize([dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.resize(eventData));
  ...
  MapVinaMap setMaxBounds(LngLatBounds? bounds) =>
      MapVinaMap.fromJsObject(jsObject.setMaxBounds(bounds?.jsObject));
  ...
  MapVinaMap setMinZoom([num? minZoom]) =>
      MapVinaMap.fromJsObject(jsObject.setMinZoom(minZoom));
  ...
  MapVinaMap setMaxZoom([num? maxZoom]) =>
      MapVinaMap.fromJsObject(jsObject.setMaxZoom(maxZoom));
  ...
  ///  @returns {MapVinaMap} `this`
  MapVinaMap setMinPitch([num? minPitch]) =>
      MapVinaMap.fromJsObject(jsObject.setMinPitch(minPitch));
  ...
  ///  @returns {MapVinaMap} `this`
  MapVinaMap setMaxPitch([num? maxPitch]) =>
      MapVinaMap.fromJsObject(jsObject.setMaxPitch(maxPitch));
  ...
  ///  @see [Render world copies](https://mapvina.com/mapvina-gl-js/docs/examples/render-world-copies/)
  ...
  ///  @see [Render world copies](https://mapvina.com/mapvina-gl-js/docs/examples/render-world-copies/)
  MapVinaMap setRenderWorldCopies([bool? renderWorldCopies]) =>
      MapVinaMap.fromJsObject(
  ...
  // MapVinaMap on(String type, [dynamic layerIdOrListener, Listener listener]);

  ///  Removes an event listener for layer-specific events previously added with `MapVinaMap#on`.
  ///
  ...
  ///  @returns {MapVinaMap} `this`
  // Defined in evented.dart
  // MapVinaMap off(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  ///  Omitting this parameter (i.e. calling [MapVinaMap.queryRenderedFeatures] with zero arguments,
  ///  or with only a [options] argument) is equivalent to passing a bounding box encompassing the entire
  ///  map viewport.
  ///  @param {Object} [options]
  ///  @param `{Array<string>}` `options.layers` An array of [style layer IDs](https://mapvina.com/mapvina-style-spec/#layer-id) for the query to inspect.
  ///    Only features within these layers will be returned. If this parameter is undefined, all layers will be checked.
  ///  @param {Array} `options.filter` A [filter](https://mapvina.com/mapvina-style-spec/#other-filter)
  ///    to limit query results.
  ///  @param {boolean} [options.validate=true] Whether to check if the `options.filter` conforms to the MapVina JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///
  ...
  ///  @see [Get features under the mouse pointer](https://mapvina.com/mapvina-gl-js/docs/examples/queryrenderedfeatures/)
  ///  @see [Highlight features within a bounding box](https://mapvina.com/mapvina-gl-js/docs/examples/using-box-queryrenderedfeatures/)
  ///  @see [Filter features within map view](https://mapvina.com/mapvina-gl-js/docs/examples/filter-features-within-map-view/)
  ...
  ///  @param {Array} `parameters.filter` A [filter](https://mapvina.com/mapvina-style-spec/#other-filter)
  ///    to limit query results.
  ///  @param {boolean} `parameters.validate=true` Whether to check if the `parameters.filter` conforms to the MapVina JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///
  ///  @returns {Array<Object>} An array of [GeoJSON](http://geojson.org/)
  ///  [Feature objects](https://tools.ietf.org/html/rfc7946#section-3.2).
  ///
  ///  In contrast to [MapVinaMap.queryRenderedFeatures], this function returns all features matching the query parameters,
  ...
  ///  });
  ///
  ///  @see [Highlight features containing similar data](https://mapvina.com/mapvina-gl-js/docs/examples/query-similar-features/)
  ...
  ///  Updates the map's MapVina style object with a new value.
  ///
  ...
  ///    [MapVina Style Specification](https://mapvina.com/mapvina-style-spec/), or a URL to such JSON.
  ///  @param {Object} [options]
  ...
  ///  @returns {MapVinaMap} `this`
  ///  @see [Change a map's style](https://mapvina.com/mapvina-gl-js/docs/examples/setstyle/)
  MapVinaMap setStyle(dynamic style, [dynamic options]) {
    final styleJs =
        style is Style ? style.jsObject as JSAny : utils.jsify(style);
    final optionsJs = utils.jsify(options);
    return MapVinaMap.fromJsObject(jsObject.setStyle(styleJs, optionsJs));
  }

  ///  Returns the map's MapVina style object, which can be used to recreate the map's style.
  ///
  ...
  /// Return each layer of the  MapVina style object, which can be used to check the order, toggle the visibility or change properties
  ...
  ///  MapVina Style Specification's [source definition](https://mapvina.com/mapvina-style-spec/#sources) or
  ///  [CanvasSourceOptions].
  ///  @fires source.add
  ///  @returns {MapVinaMap} `this`
  ///  });
  ///  @see Vector source: [Show and hide layers](https://mapvina.com/mapvina-gl-js/docs/examples/toggle-layers/)
  ///  @see GeoJSON source: [Add live realtime data](https://mapvina.com/mapvina-gl-js/docs/examples/live-geojson/)
  ///  @see Raster DEM source: [Add hillshading](https://mapvina.com/mapvina-gl-js/docs/examples/hillshade/)
  MapVinaMap addSource(String id, dynamic source) {
    if (source is Source) {
      return MapVinaMap.fromJsObject(jsObject.addSource(id, source.jsObject));
    }
  ...
  ///  @see [Create a draggable point](https://mapvina.com/mapvina-gl-js/docs/examples/drag-a-point/)
  ///  @see [Animate a point](https://mapvina.com/mapvina-gl-js/docs/examples/animate-point-along-line/)
  ///  @see [Add live realtime data](https://mapvina.com/mapvina-gl-js/docs/examples/live-geojson/)
  ...
  ///  [`icon-image`](https://mapvina.com/mapvina-style-spec/#layout-symbol-icon-image),
  ///  [`background-pattern`](https://mapvina.com/mapvina-style-spec/#paint-background-background-pattern),
  ///  [`fill-pattern`](https://mapvina.com/mapvina-style-spec/#paint-fill-fill-pattern),
  ///  or [`line-pattern`](https://mapvina.com/mapvina-style-spec/#paint-line-line-pattern).
  ///  A {@link MapVinaMap#error} event will be fired if there is not enough space in the sprite to add this image.
  ///
  ...
  ///
  ///
  ///  @see Use `HTMLImageElement`: [Add an icon to the map](https://mapvina.com/mapvina-gl-js/docs/examples/add-image/)
  ///  @see Use `ImageData`: [Add a generated icon to the map](https://mapvina.com/mapvina-gl-js/docs/examples/add-image-generated/)
  ...
  ///  Load an image from an external URL to be used with `MapVinaMap#addImage`. External
  ...
  ///  });
  ///
  ///  @see [Add an icon to the map](https://mapvina.com/mapvina-gl-js/docs/examples/add-image/)
  ...
  ///  Adds a [MapVina style layer](https://mapvina.com/mapvina-style-spec/#layers)
  ///  to the map's style.
  ///
  ///  A layer defines how data from a specified source will be styled. Read more about layer types
  ///  and available paint and layout properties in the [MapVina Style Specification](https://mapvina.com/mapvina-style-spec/#layers).
  ///
  ///  @param {Object | CustomLayerInterface} layer The style layer to add, conforming to the MapVina Style Specification's
  ///    [layer definition](https://mapvina.com/mapvina-style-spec/#layers).
  ///  @param {string} [beforeId] The ID of an existing layer to insert the new layer before.
  ///    If this argument is omitted, the layer will be appended to the end of the layers array.
  ///
  ///  @returns {MapVinaMap} `this`
  ///
  ///  @see [Create and style clusters](https://mapvina.com/mapvina-gl-js/docs/examples/cluster/)
  ///  @see [Add a vector tile source](https://mapvina.com/mapvina-gl-js/docs/examples/vector-source/)
  ///  @see [Add a WMS source](https://mapvina.com/mapvina-gl-js/docs/examples/wms/)
  MapVinaMap addLayer(dynamic layer, [String? beforeId]) {
    if (layer is Layer) {
      return MapVinaMap.fromJsObject(
  ...
  MapVinaMap moveLayer(String id, String beforeId) =>
      MapVinaMap.fromJsObject(jsObject.moveLayer(id, beforeId));
  ...
  ///
  ///  @see [Filter symbols by toggling a list](https://mapvina.com/mapvina-gl-js/docs/examples/filter-markers/)
  ///  @see [Filter symbols by text input](https://mapvina.com/mapvina-gl-js/docs/examples/filter-markers-by-input/)
  dynamic getLayer(String id) => jsObject.getLayer(id);

  ///  Sets the zoom extent for the specified style layer. The zoom extent includes the
  ///  [minimum zoom level](https://mapvina.com/mapvina-style-spec/#layer-minzoom)
  ///  and [maximum zoom level](https://mapvina.com/mapvina-style-spec/#layer-maxzoom))
  ...
  MapVinaMap setLayerZoomRange(String layerId, num minzoom, num maxzoom) =>
      MapVinaMap.fromJsObject(
  ...
  ///  @param {Array | null | undefined} filter The filter, conforming to the MapVina Style Specification's
  ///    [filter definition](https://mapvina.com/mapvina-style-spec/#other-filter).  If `null` or `undefined` is provided, the function removes any existing filter from the layer.
  ///  @param {Object} [options]
  ///  @param {boolean} [options.validate=true] Whether to check if the filter conforms to the MapVina JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///
  ///  @returns {MapVinaMap} `this`
  ///  @example
  ...
  ///  @see [Filter features within map view](https://mapvina.com/mapvina-gl-js/docs/examples/filter-features-within-map-view/)
  ///  @see [Highlight features containing similar data](https://mapvina.com/mapvina-gl-js/docs/examples/query-similar-features/)
  ///  @see [Create a timeline animation](https://mapvina.com/mapvina-gl-js/docs/examples/timeline-animation/)
  MapVinaMap setFilter(
    String layerId,
    dynamic filter, [
    StyleSetterOptions? options,
  ]) => MapVinaMap.fromJsObject(jsObject.setFilter(layerId, filter));
  ...
  ///    Must be of a type appropriate for the property, as defined in the [MapVina Style Specification](https://mapvina.com/mapvina-style-spec/).
  ///  @param {Object} [options]
  ///  @param {boolean} [options.validate=true] Whether to check if `value` conforms to the MapVina JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {MapVinaMap} `this`
  ///  @example
  ///  map.setPaintProperty('my-layer', 'fill-color', '#faafee');
  ///  @see [Change a layer's color with buttons](https://mapvina.com/mapvina-gl-js/docs/examples/color-switcher/)
  ///  @see [Adjust a layer's opacity](https://mapvina.com/mapvina-gl-js/docs/examples/adjust-layer-opacity/)
  ///  @see [Create a draggable point](https://mapvina.com/mapvina-gl-js/docs/examples/drag-a-point/)
  setPaintProperty(
    String layerId,
    String name,
  ...
  ///  @param {*} value The value of the layout property. Must be of a type appropriate for the property, as defined in the [MapVina Style Specification](https://mapvina.com/mapvina-style-spec/).
  ///  @param {Object} [options]
  ///  @param {boolean} [options.validate=true] Whether to check if `value` conforms to the MapVina JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {MapVinaMap} `this`
  ///  @example
  ///  map.setLayoutProperty('my-layer', 'visibility', 'none');
  MapVinaMap setLayoutProperty(
    String layerId,
    String name,
    dynamic value, [
    StyleSetterOptions? options,
  ...
  ///
  ///  @param light Light properties to set. Must conform to the [MapVina Style Specification](https://mapvina.com/mapvina-style-spec/#light).
  ///  @param {Object} [options]
  ///  @param {boolean} [options.validate=true] Whether to check if the filter conforms to the MapVina JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {MapVinaMap} `this`
  MapVinaMap setLight(dynamic light, StyleSetterOptions options) =>
      MapVinaMap.fromJsObject(jsObject.setLight(light, options.jsObject));
  ...
  ///  [MapVinaMap.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  ///  Feature objects returned from [MapVinaMap.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  ///  @see [Measure distances](https://mapvina.com/mapvina-gl-js/docs/examples/measure/)
  ///  @see [Display a popup on hover](https://mapvina.com/mapvina-gl-js/docs/examples/popup-on-hover/)
  ///  @see [Center the map on a clicked symbol](https://mapvina.com/mapvina-gl-js/docs/examples/center-on-symbol/)
  ...
  ///  The version of MapVina JS JS in use as specified in package.json, CHANGELOG.md, and the GitHub release.
  ///
  ///  @name version
  ///  @instance
  ///  @memberof MapVinaMap
  ...
  /// Creates a new MapVinaMap from a [jsObject].
  MapVinaMap.fromJsObject(this.jsObject) : super.fromJsObject(jsObject);
}
...
class MapOptions extends JsObjectWrapper<MapOptionsJsImpl> {
  ...
  /// The HTML element in which MapVina JS JS will render the map, or the element's string `id`. The specified element must have no children.
  ...
  /// A string representing the position of the MapVina wordmark on the map. Valid options are `top-left`,`top-right`, `bottom-left`, `bottom-right`.
  String get logoPosition => jsObject.logoPosition.toDart;

  /// WebGL context attributes including `preserveDrawingBuffer`, `antialias`,
  /// and `failIfMajorPerformanceCaveat`. In MapVina GL JS v5+, these are
  ...
  ///  The map's MapVina style. This must be an a JSON object conforming to
  ///  the schema described in the [MapVina Style Specification](https://mapvina.com/mapvina-style-spec/), or a URL to
  ///  such JSON.
  ...
  /// The inital geographical centerpoint of the map. If `center` is not specified in the constructor options, MapVina JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `[0, 0]` Note: MapVina JS uses longitude, latitude coordinate order (as opposed to latitude, longitude) to match GeoJSON.
  LngLat get center => LngLat.fromJsObject(jsObject.center);

  /// The initial zoom level of the map. If `zoom` is not specified in the constructor options, MapVina JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
  num get zoom => jsObject.zoom.toDartDouble;

  /// The initial bearing (rotation) of the map, measured in degrees counter-clockwise from north. If `bearing` is not specified in the constructor options, MapVina JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
  num get bearing => jsObject.bearing.toDartDouble;

  /// The initial pitch (tilt) of the map, measured in degrees away from the plane of the screen (0-60). If `pitch` is not specified in the constructor options, MapVina JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
  ...
  /// In these ranges, font settings from the map's style will be ignored, except for font-weight keywords (light/regular/medium/bold).
  /// Set to `false`, to enable font settings from the map's style for these glyph ranges.
  /// The purpose of this option is to avoid bandwidth-intensive glyph server requests. (See [Use locally generated ideographs](https://mapvina.com/mapvina-gl-js/docs/examples/local-ideographs).)
  String get localIdeographFontFamily =>
      jsObject.localIdeographFontFamily.toDart;

  /// A callback run before the MapVinaMap makes a request for an external URL. The callback can be used to modify the url, set headers, or set the credentials property for cross-origin requests.
  ...
  factory MapOptions({
    ...
    // In MapVina GL JS v5+, WebGL context options moved into canvasContextAttributes
...
///  element, which is often a `div` element. To use MapVina JS JS's
///  default control styling, add the `mapvinagl-ctrl` class to your control's
///  node.
///
/// ```dart
...
///
///   @override
///   HtmlElement onAdd(MapVinaMap map) {
...
class IControl extends JsObjectWrapper<IControlJsImpl> {
  ...
  ///  and resources. This method is called by {@link MapVinaMap#addControl}
  ///  internally.
  HtmlElement onAdd(MapVinaMap map) => jsObject.onAdd(map.jsObject);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link MapVinaMap#removeControl}
  ///  internally.
  onRemove(MapVinaMap map) => jsObject.onRemove(map.jsObject);

  ///  Optionally provide a default position for this control. If this method
  ///  is implemented and {@link MapVinaMap#addControl} is called without the `position`
