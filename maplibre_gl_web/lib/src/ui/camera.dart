...
import 'package:mapvina_gl_web/src/ui/map.dart';
import 'package:mapvina_gl_web/src/util/evented.dart';
import 'package:mapvina_gl_web/src/utils.dart' as utils;

///  Options common to {@link MapVinaMap#jumpTo}, [MapVinaMap.easeTo], and {@link MapVinaMap#flyTo}, controlling the desired location,
...
///  Options common to map movement methods that involve animation, such as {@link MapVinaMap#panBy} and
///  [MapVinaMap.easeTo], controlling the duration and easing function of the animation. All properties
///  are optional.
///
...
///  Options for setting padding on a call to {@link MapVinaMap#fitBounds}. All properties of this object must be
...
class Camera extends Evented {
  ...
  ///  @example
  ///  map.setCenter([-74, 38]);
  MapVinaMap setCenter(LngLat center, [dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.setCenter(center.jsObject));
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  ///  @see [Navigate the map with game-like controls](https://mapvina.com/mapvina-gl-js/docs/examples/game-controls/)
  MapVinaMap panBy(
    Point offset, [
    AnimationOptions? options,
    dynamic eventData,
  ]) => MapVinaMap.fromJsObject(jsObject.panBy(offset.jsObject));
  ...
  MapVinaMap panTo(
    ...
    AnimationOptions? options,
    dynamic eventData,
  ]) => MapVinaMap.fromJsObject(jsObject.panTo(lnglat.jsObject));
  ...
  ///  // zoom the map to 5
  ///  map.setZoom(5);
  MapVinaMap setZoom(num zoom, [dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.setZoom(zoom));
  ...
  MapVinaMap zoomTo(
    ...
    AnimationOptions? options,
    dynamic eventData,
  ]) => MapVinaMap.fromJsObject(jsObject.zoomTo(zoom));
  ...
  ///  @fires zoomend
  ///  @returns {MapVinaMap} `this`
  MapVinaMap zoomIn([AnimationOptions? options, dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.zoomIn());
  ...
  ///  @fires zoomend
  ///  @returns {MapVinaMap} `this`
  MapVinaMap zoomOut([AnimationOptions? options, dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.zoomOut());
  ...
  ///  map.setBearing(90);
  MapVinaMap setBearing(num bearing, [dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.setBearing(bearing));
  ...
  MapVinaMap rotateTo(
    ...
    AnimationOptions? options,
    dynamic eventData,
  ]) => MapVinaMap.fromJsObject(jsObject.rotateTo(bearing));
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  MapVinaMap resetNorth([AnimationOptions? options, dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.resetNorth());
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  MapVinaMap resetNorthPitch([AnimationOptions? options, dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.resetNorthPitch());
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  MapVinaMap snapToNorth([AnimationOptions? options, dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.snapToNorth());
  ...
  ///  @fires moveend
  ///  @returns {MapVinaMap} `this`
  MapVinaMap setPitch(num pitch, [dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.setPitch(pitch));

  ///  @memberof MapVinaMap#
  ///  @param {LatLngBoundsLike} bounds Calculate the center for these bounds in the viewport and use
  ///       the highest zoom level up to and including `MapVinaMap#getMaxZoom()` that fits
  ...
  ///       zoom level up to and including `MapVinaMap#getMaxZoom()` that fits them in the viewport.
  ...
  ///      [MapVinaMap.easeTo]. If `false`, the map transitions using {@link MapVinaMap#flyTo}. See
  ...
  ///    padding: {top: 10, bottom:25, left: 15, right: 5}
  ///  });
  ///  @see [Fit a map to a bounding box](https://mapvina.com/mapvina-gl-js/docs/examples/fitbounds/)
  MapVinaMap fitBounds(
    LngLatBounds bounds, [
  ...
  ///    padding: {top: 10, bottom:25, left: 15, right: 5}
  ///  });
  ///  @see [Used by BoxZoomHandler](https://mapvina.com/mapvina-gl-js/docs/API/classes/mapvinagl.BoxZoomHandler/)
  MapVinaMap fitScreenCoordinates(
    Point p0,
    Point p1,
    num bearing, [
    dynamic options,
  ...
  ///  @fires pitchend
  ///  @returns {MapVinaMap} `this`
  MapVinaMap jumpTo(CameraOptions options, [dynamic eventData]) =>
      MapVinaMap.fromJsObject(jsObject.jumpTo(options.jsObject));
  ...
  ///  @returns {MapVinaMap} `this`
  ///  @see [Navigate the map with game-like controls](https://mapvina.com/mapvina-gl-js/docs/examples/game-controls/)
  MapVinaMap easeTo(dynamic options, [dynamic eventData]) {
    JSAny optionsJs;
    ...
    return MapVinaMap.fromJsObject(jsObject.easeTo(optionsJs));
  }
  ...
  ///      value minimizes zooming for an effect closer to [MapVinaMap.easeTo]. 1.42 is the average
  ...
  ///    }
  ///  });
  ///  @see [Fly to a location](https://mapvina.com/mapvina-gl-js/docs/examples/flyto/)
  ///  @see [Slowly fly to a location](https://mapvina.com/mapvina-gl-js/docs/examples/flyto-options/)
  ///  @see [Fly to a location based on scroll position](https://mapvina.com/mapvina-gl-js/docs/examples/scroll-fly-to/)
  MapVinaMap flyTo(dynamic options, [String? eventData]) {
    JSAny optionsJs;
    if (options is CameraOptions) {
      optionsJs = options.jsObject as JSAny;
    } else if (options is Map) {
    ...
    return MapVinaMap.fromJsObject(jsObject.flyTo(optionsJs));
  }
  ...
  ///  @memberof MapVinaMap#
  ///  @returns {MapVinaMap} `this`
  MapVinaMap stop() => MapVinaMap.fromJsObject(jsObject.stop());
