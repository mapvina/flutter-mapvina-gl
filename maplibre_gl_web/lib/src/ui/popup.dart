...
///  };
/// var popup = new mapvinagl.Popup({offset: popupOffsets, className: 'my-class'})
///   .setLngLat(e.lngLat)
...
/// @see [Display a popup on click](https://mapvina.com/mapvina-gl-js/docs/examples/popup-on-click/)
/// @see [Attach a popup to a marker instance](https://mapvina.com/mapvina-gl-js/docs/examples/set-popup/)
class Popup extends Evented {
  ...
  ///
  /// @param {MapVinaMap} map The MapVina JS JS map to add the popup to.
  /// @returns {Popup} `this`
  ////
  Popup addTo(MapVinaMap map) =>
  ...
  ///
  /// @example
  /// var popup = new mapvinagl.Popup().addTo(map);
  /// popup.remove();
  /// @returns {Popup} `this`
