// Code generation entry point for the MapVina Flutter workspace.
//
...
Future<void> main() async {
  ...
  const templates = [
    "mapvina_gl/android/src/main/java/org/mapvina/mapvinagl/LayerPropertyConverter.java",
    "mapvina_gl/ios/mapvina_gl/Sources/mapvina_gl/LayerPropertyConverter.swift",
    "mapvina_gl/lib/src/layer_expressions.dart",
    "mapvina_gl/lib/src/layer_properties.dart",
    "mapvina_gl_web/lib/src/layer_tools.dart",
    "mapvina_gl_platform_interface/lib/src/source_properties.dart",
  ];
...
Map<String, dynamic> buildStyleProperty(
  ...
  // MapVina 6.24.0+ changed some hillshade properties to array types
