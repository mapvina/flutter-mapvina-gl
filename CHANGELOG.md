...
## [0.26.1](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.26.0...v0.26.1)
...
## [0.26.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.25.0...v0.26.0)
...
* **Web**: Upgraded MapVina GL JS from 4.7.1 to [5.24.0](https://github.com/mapvina/mapvina-gl-js/releases/tag/v5.21.0) (#761, #651).
...
**Full Changelog**: [v0.25.0...v0.26.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.25.0...v0.26.0)

## [0.25.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.24.1...v0.25.0) - 2026-01-07
...
* MapVina Android SDK upgraded from `11.13.5` to `12.3.0` (#690).
  ...
  - See [MapVina Native Android 12.3.0 release notes](https://github.com/mapvina/mapvina-native/releases/tag/android-v12.3.0)
...
**Full Changelog**: [v0.24.1...v0.25.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.24.1...v0.25.0)

## [0.24.1](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.24.0...v0.24.1)
...
## [0.24.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.23.0...v0.24.0)
...
**Full Changelog**: [v0.23.0...v0.24.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.23.0...v0.24.0)

## [0.23.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.22.0...v0.23.0)
> **Note**: This release has breaking changes.
...
**Full Changelog**: [v0.22.0...v0.23.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.22.0...v0.23.0)


## [0.22.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.21.0...v0.22.0)

### Breaking changes

* Updated mapvina-native for iOS to v6.14.0. This mainly introduces PMTiles support. See the
  [mapvina-native changelog](https://github.com/mapvina/mapvina-native/blob/main/platform/ios/CHANGELOG.md#6121)
...
* Updated mapvina-native for Android to v11.9.0. This mainly introduces PMTiles support.
  ...
  See the [mapvina-native changelog](https://github.com/mapvina/mapvina-native/blob/main/platform/android/CHANGELOG.md#1181)
  for more information.
...
## [0.21.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.20.0...v0.21.0)
...
* Updated mapvina-native for ios to v6.5.0. This introduces the new
  ...
  [mapvina-native changelog](https://github.com/mapvina/mapvina-native/blob/main/platform/ios/CHANGELOG.md#600)
  for more information.
* Updated mapvina-native for android to v11.0.0. This version uses
  OpenGL ES 3.0. See the
  [mapvina-native changelog](https://github.com/mapvina/mapvina-native/blob/main/platform/android/CHANGELOG.md#1100)
  for more information.
...
**Full Changelog**:
[v0.19.0+2...v0.20.0](https://github.com/mapvina/flutter-mapvina-gl/compare/v0.19.0+2...v0.20.0)
...
* Add support for
  the [Fill Extrusion layer](https://mapvina.com/mapvina-style-spec/layers/#fill-extrusion)
* Add support for
  the [Heatmap layer](https://mapvina.com/mapvina-style-spec/layers/#heatmap)
...
**Full Changelog**:
[0.18.0...v0.19.0](https://github.com/mapvina/flutter-mapvina-gl/compare/0.18.0...v0.19.0)
...
* new feature: set arbitrary layer properties by @m0nac0
  in [#303](https://github.com/mapvina/flutter-mapvina-gl/pull/303)
* Update release process by @m0nac0
  in [#315](https://github.com/mapvina/flutter-mapvina-gl/pull/315)
* Add workflows for automated publishing to pub.dev by @m0nac0
  in [#328](https://github.com/mapvina/flutter-mapvina-gl/pull/328)
* Fix example app pubspec by @m0nac0
  in [#329](https://github.com/mapvina/flutter-mapvina-gl/pull/329)
* Updated location plugin version for example app by @varunlohade
  in [#334](https://github.com/mapvina/flutter-mapvina-gl/pull/334)
* Housekeeping: Improve docs and update outdated references to point to MapVina
  by @m0nac0 in [#330](https://github.com/mapvina/flutter-mapvina-gl/pull/330)

**Full Changelog**:
[0.17.0...0.18.0](https://github.com/mapvina/flutter-mapvina-gl/compare/0.17.0...0.18.0)

## 0.17.0

* **Repository transfer**: The project repository was transferred to the
  MapVina GitHub organization. More information
  at [#221](https://github.com/mapvina/flutter-mapvina-gl/issues/221)
* Developers do not need to adapt their Podfile for iOS apps anymore as it was
  previously described in the
  Readme. [#278](https://github.com/mapvina/flutter-mapvina-gl/pull/278)
...
* `useDelayedDisposal` was removed since its now fixed
  in [#259](https://github.com/mapvina/flutter-mapvina-gl/pull/259)
* `useHybridCompositionOverride` was removed since it was added in the following
  fix: [#203](https://github.com/mapvina/flutter-mapvina-gl/pull/203) and we
  reverted
...
* The default for `myLocationRenderMode` was changed from `COMPASS` to `NORMAL`
  in [#244](https://github.com/mapvina/flutter-mapvina-gl/pull/244), since the
...
* feat: add support for reading style json from file in ios by @TimAlber
  in [#132](https://github.com/mapvina/flutter-mapvina-gl/pull/132)
* Add podspecs in correct Cocoapods layout by @kuhnroyal
  in [#128](https://github.com/mapvina/flutter-mapvina-gl/pull/128)
* fix: fix the queryRenderedFeatures code on iOS by @TimAlber
  in [#137](https://github.com/mapvina/flutter-mapvina-gl/pull/137)
* feat: Set layer visibility by @m0nac0
  in [#138](https://github.com/mapvina/flutter-mapvina-gl/pull/138)
* feat: add support for changing the receiver’s viewport to fit given bounds by
  @TimAlber in [#133](https://github.com/mapvina/flutter-mapvina-gl/pull/133)
* Change feature JSON encoding from .ascii to .utf8 by @SunBro-Marko
  in [#142](https://github.com/mapvina/flutter-mapvina-gl/pull/142)
* web: implement setCameraBounds by @m0nac0
  in [#145](https://github.com/mapvina/flutter-mapvina-gl/pull/145)
* Use offical mapvina-gl.js and add README info by @Robbendebiene
  in [#163](https://github.com/mapvina/flutter-mapvina-gl/pull/163)
* android: adding tileSize to raster source by @mariusvn
  in [#166](https://github.com/mapvina/flutter-mapvina-gl/pull/166)
* Readme: document git default values for codespaces by @m0nac0
  in [#170](https://github.com/mapvina/flutter-mapvina-gl/pull/170)
* query source features by @Grodien
  in [#154](https://github.com/mapvina/flutter-mapvina-gl/pull/154)
* Trimming styleString to simplify the JSON detection by @mariusvn
  in [#175](https://github.com/mapvina/flutter-mapvina-gl/pull/175)
* Fix getVisibleRegion method by @BartoszStasiurka
  in [#179](https://github.com/mapvina/flutter-mapvina-gl/pull/179)
* Reenable textureMode which was disabled in f8b2d1 by @maxammann
  in [#194](https://github.com/mapvina/flutter-mapvina-gl/pull/194)
* android: Bump MapVina SDK to 9.6.0 & OkHttp to 4.9.3 by @mariusvn
  in [#184](https://github.com/mapvina/flutter-mapvina-gl/pull/184)
* Added getSourceIds to the controller by @mariusvn
  in [#197](https://github.com/mapvina/flutter-mapvina-gl/pull/197)
* Moved EventChannel creation in the downloadOfflineRegion method by @mariusvn
  in [#205](https://github.com/mapvina/flutter-mapvina-gl/pull/205)
* Fix crash android dispose nullpointerdereference by @GaelleJoubert
  in [#203](https://github.com/mapvina/flutter-mapvina-gl/pull/203)
* Migrate links in README, pubspec to MapVina by @kuhnroyal
  in [#224](https://github.com/mapvina/flutter-mapvina-gl/pull/224)
* Update LICENSE file by @mariusvn
  in [#230](https://github.com/mapvina/flutter-mapvina-gl/pull/230)
* upgrade dependency image by @m0nac0
  in [#248](https://github.com/mapvina/flutter-mapvina-gl/pull/248)
* fix-example-app by @JulianBissekkou
  in [#261](https://github.com/mapvina/flutter-mapvina-gl/pull/261)
* 162-animate-camera-on-web-fix by @JulianBissekkou
  in [#254](https://github.com/mapvina/flutter-mapvina-gl/pull/254)
* 243-fix-crash-when-no-location-permission by @JulianBissekkou
  in [#244](https://github.com/mapvina/flutter-mapvina-gl/pull/244)
* 182-disposal-null-ref-crash by @JulianBissekkou
  in [#259](https://github.com/mapvina/flutter-mapvina-gl/pull/259)
* New android sdk version by @stefanschaller
  in [#270](https://github.com/mapvina/flutter-mapvina-gl/pull/270)
* 250-change-language-fixes by @stefanschaller
  in [#275](https://github.com/mapvina/flutter-mapvina-gl/pull/275)
* upgrade-ios-version by @JulianBissekkou
  in [#277](https://github.com/mapvina/flutter-mapvina-gl/pull/277)
* Simplify iOS usage instructions and example podfile by @m0nac0
  in [#278](https://github.com/mapvina/flutter-mapvina-gl/pull/278)
* Add opportunity to use map in widget tests by @ManoyloK
  in [#281](https://github.com/mapvina/flutter-mapvina-gl/pull/281)
* fix-layers-prod-build by @stefanschaller
  in [#291](https://github.com/mapvina/flutter-mapvina-gl/pull/291)
* Fix the codespace by upgrading the docker image by @ouvreboite
  in [#297](https://github.com/mapvina/flutter-mapvina-gl/pull/297)
* Add `updateImageSource`. by @CaviarChen
  in [#271](https://github.com/mapvina/flutter-mapvina-gl/pull/271)
* fix "unexpected null value" error when onStyleLoadedCallback is null by
  @m0nac0 in [#307](https://github.com/mapvina/flutter-mapvina-gl/pull/307)
* attributionButtonPosition for web by @ouvreboite
  in [#304](https://github.com/mapvina/flutter-mapvina-gl/pull/304)

**Full Changelog**:
https://github.com/mapvina/flutter-mapvina-gl/compare/0.16.0...0.17.0
